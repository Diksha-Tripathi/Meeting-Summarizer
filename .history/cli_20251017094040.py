...
# --- Configuration ---
# Using the official Whisper API model for higher accuracy and fewer local dependencies.
TRANSCRIPTION_MODEL = "whisper-1"
# A powerful and cost-effective model that supports JSON mode.
SUMMARIZATION_MODEL = "gpt-4o-mini"
TOKENIZER_ENCODING = "cl100k_base"
# Max tokens for the LLM, leaving room for the response.
MAX_TOKENS_PER_CHUNK = 8000

# --- Global flag to control the ticker ---
...
def display_ticker():
    ...
    while not stop_ticker_flag:
        ...
        # Write to stdout so the GUI doesn't capture it as an error.
...
def record_audio(output_filename):
    ...
    process = None
    try:
        # Check OS to select the correct ffmpeg input device format.
